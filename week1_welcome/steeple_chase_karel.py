...
Hurdles are of orbitrary height and placement
"""
def main():
    jump_hurdle()
    ascend_hurdle()
...
def jump_hurdle():
    ...
    Post-condition: Facing East at bottom in next avenue after
    hurdle
    """
    ascend_hurdle()
    move()
...
def ascend_hurdle():
    """
    Pre-condition: Facing East at bottom of hurdle.
    Post-condition: Facing East inmediately above hurdle
    """
    turn_left()
    while right_is_block():
        move()
    turn_right()
...
def turn_right():
    ...
    Post-condition: Karel is facing to the right of whichever
                    direction was facing previously
    """
    for i in range(3):
        turn_left()
