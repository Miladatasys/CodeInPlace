"""
For the last milestone, it is helpful 
to notice that if you add the row and 
the column number together, you get 
a number. If that number is even, you 
should color the square black.

Note: If you're using a screen reader, 
it may be helpful to decrease the size 
of the chess board for easier debugging.
"""
